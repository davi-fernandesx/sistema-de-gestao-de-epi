...
type ItemParaInserir struct {
	ID_epi           int64             `json:"id_epi" binding:"required,numeric"`
	ID_tamanho       int64             `json:"id_tamanho" binding:"required,numeric"`
...
type EntregaParaInserir struct {
	ID_funcionario     int64               `json:"id_funcionario" binding:"required,numeric"`
